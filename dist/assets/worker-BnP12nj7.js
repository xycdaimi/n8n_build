...
var sqlite3InitModule = (() => {
	...
	return function(moduleArg = {}) {
		...
		function findWasmBinary() {
			...
			return new URL("/%7B%7BBASE_PATH%7D%7D/assets/sqlite3-DBpDb1lf.wasm", "" + import.meta.url).href;
		}
		var wasmBinaryFile;
				...
				const installOpfsVfs = function callee(options) {
					...
					return new Promise(function(promiseResolve_, promiseReject_) {
						...
						const W = new Worker(new URL(
							/* @vite-ignore */
							"/%7B%7BBASE_PATH%7D%7D/assets/sqlite3-opfs-async-proxy-BrtqH9Si.js",
							"" + import.meta.url
						));
						setTimeout(() => {
...
globalThis.sqlite3Worker1Promiser.defaultConfig = {
	worker: function() {
		return new Worker(new URL(
			/* @vite-ignore */
			"/%7B%7BBASE_PATH%7D%7D/assets/sqlite3-worker1-bundler-friendly-BvaOkVlV.js",
			"" + import.meta.url
		), { type: "module" });
	},
