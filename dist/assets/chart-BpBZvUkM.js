...
var BarController = class extends DatasetController {
	...
	_calculateBarIndexPixels(index$1, ruler) {
		...
		if (ruler.grouped) {
			...
			const range = options.barThickness === "flex" ? computeFlexCategoryTraits(index$1, ruler, options, stackCount) : computeFitCategoryTraits(index$1, ruler, options, stackCount);
			const stackIndex = this._getStackIndex(this.index, this._cachedMeta.stack, skipNull ? index$1 : void 0);
...
function fill(ctx, cfg) {
	const { line, target, property, color: color$1, scale } = cfg;
...
(class extends LinearScaleBase {
	...
	drawLabels() {
		...
		this.ticks.forEach((tick, index$1) => {
			if (index$1 === 0 && !opts.reverse) return;
...
function setMajorTicks(scale, ticks, map$2, majorUnit) {
	const adapter = scale._adapter;
...
function ticksFromTimestamps(scale, values, majorUnit) {
	...
	return ilen === 0 || !majorUnit ? ticks : setMajorTicks(scale, ticks, map$2, majorUnit);
}
...
export { LineController as a, PointElement as c, plugin_title as d, plugin_tooltip as f, Chart as i, index as l, BarElement as n, LineElement as o, CategoryScale as r, LinearScale as s, BarController as t, plugin_legend as u };
